...
import { getAboutPage } from '@/lib/api/legal';
      ...
      <div className="mx-auto w-full max-w-3xl flex-1 px-4 py-8">
        ...
        {isLoading ? (
          ...
          <div className="rounded-2xl border border-gray-200 bg-white py-16 text-center dark:border-gray-800 dark:bg-gray-900">
            <Building2 className="mx-auto mb-3 h-14 w-14 text-gray-200 dark:text-gray-700" />
            <p className="text-sm font-bold text-gray-400">회사소개 내용이 등록되지 않았습니다.</p>
          </div>
        )}
      </div>
    </div>
